...
def acc2taxid_extractor(taxnomy_folder):
    acc2taxid = {}
...
if __name__ == "__main__":
    ...
    parent_dict, merged_dict, deleted_list = generazione_dizionari_tassonomia(tax_folder)
    acc2taxid = acc2taxid_extractor(tax_folder)
